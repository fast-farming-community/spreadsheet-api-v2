defmodule FastApi.Health.Gw2Server do
  ...
  def init(:ok) do
    ...
    state = %{
      cfg: %{
        ...
        request_timeout_ms: cfg[:request_timeout_ms] || 3_000,
        stale_after_ms: cfg[:stale_after_ms] || 90_000,
        probe_grace_ms: cfg[:probe_grace_ms] || 1_000
      },
      probes:
  ...
  defp do_probe(url, tmo) do
    ...
    try do
      case Finch.request(req, FastApi.FinchHealth, receive_timeout: tmo) do
