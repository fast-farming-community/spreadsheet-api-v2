defmodule FastApi.Sync.GW2API do
  ...
  @doc """
  Fetches prices, updates only changed rows in DB, and returns:

      {:ok, %{updated: count, changed_ids: MapSet.t()}}
  """
  ...
  @doc """
  Updates the Google Sheet. Only pushes changed rows to C:D (buy/sell).
